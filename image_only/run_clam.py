...
def run_all():
    ...
    print("========== Runtime Config (CLAM Train) ==========")
    ...
    summary_csv = os.path.join(LOCAL_CONFIG["LOG_ROOT"], "FINAL_IMAGE_ONLY_SUMMARY_CLAM.csv")
