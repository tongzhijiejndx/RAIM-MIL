...
def run_all():
    ...
    print("========== Runtime Config (ABMIL Train) ==========")
    ...
    for current_task in ALL_TASKS:
        ...
        for fold, (train_idx, val_idx) in fold_pbar:
            ...
            # 重新载入 best checkpoint，在该 fold 的 validation set 上保存预测与 ROC 原始数据
    ...
    summary_csv = os.path.join(LOCAL_CONFIG["LOG_ROOT"], "FINAL_IMAGE_ONLY_SUMMARY_ABMIL.csv")
